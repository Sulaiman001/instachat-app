package com.app.instachat.activities.views.audiowave;
...
import com.app.instachat.activities.views.voiceplayer.FileUtils;
import com.app.instachat.activities.views.voiceplayer.PlayerVisualizerSeekbar;
            ...
            try {
                ...
                mediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                    ...
                    public void onPrepared(MediaPlayer mp) {
                        ...
                        txtProcess.setText(Utils.convertSecondsToHMmSs(mp.getDuration()));
                    }
                });
        ...
        ((Activity) context).runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (mediaPlayer.getDuration() - mediaPlayer.getCurrentPosition() > 100) {
                    time.setText(Utils.convertSecondsToHMmSs(mediaPlayer.getCurrentPosition()));
                } else {
                    time.setText(Utils.convertSecondsToHMmSs(mediaPlayer.getDuration()));
