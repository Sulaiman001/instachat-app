...
public class User implements Serializable {
    ...
    private int isOnline = IConstants.STATUS_OFFLINE;
    ...
    private int genders = IConstants.GEN_UNSPECIFIED;
    private String lastSeen;
    private boolean isChecked;
    private boolean isAdmin;
    private boolean hideEmail = IConstants.FALSE;
    private boolean hideProfilePhoto = IConstants.FALSE;
    private String signup_type = IConstants.TYPE_EMAIL;
