...
import com.app.instachat.activities.fragments.ChatsFragment;
import com.app.instachat.activities.fragments.ProfileFragment;
import com.app.instachat.activities.managers.Utils;
import com.app.instachat.activities.models.User;
import com.app.instachat.activities.views.CustomTypefaceSpan;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabMain.setOnClickListener(new SingleClickListener() {
            ...
            public void onClickView(View v) {
                ...
                }else if (mViewPager.getCurrentItem() == ZERO) {
                    screens.showCustomScreen(UsersActivity.class);
                }
            }
        });
    ...
    public void rotateFabForward() {
        ...
        //Write whatever you want to do after delay specified (1 sec)
