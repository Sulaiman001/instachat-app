package com.app.instachat.activities.views.voiceplayer;
...
import com.app.instachat.activities.views.audiowave.MyDrawableCompat;
...
public class RecordingPlayerView extends LinearLayout {
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            headsetDirection = typedArray.getInt(R.styleable.VoicePlayerView_headsetDirection, IConstants.ZERO);
            ...
            try {
                ...
                mediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                    ...
                    public void onPrepared(MediaPlayer mp) {
                        ...
                        txtProcess.setText(DEFAULT_ZERO + " / " + Utils.convertSecondsToHMmSs(mp.getDuration()));
                    }
                });
    ...
    private void broadcastDownloadEvent(MediaPlayer mediaPlayer) {
        Intent intent = new Intent(IConstants.BROADCAST_PLAY_RECORDING_EVENT);
        intent.putExtra(IConstants.PLAYING_DATA, (Serializable) mediaPlayer);
        ...
        ((Activity) context).runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (mediaPlayer.getDuration() - mediaPlayer.getCurrentPosition() > 100) {
                    time.setText(Utils.convertSecondsToHMmSs(mediaPlayer.getCurrentPosition()) + " / " + Utils.convertSecondsToHMmSs(mediaPlayer.getDuration()));
                } else {
                    time.setText(DEFAULT_ZERO + " / " + Utils.convertSecondsToHMmSs(mediaPlayer.getDuration()));
